...
for filename in os.listdir(images_path):
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        # Assuming Instagram ID is stored in the filename (change this if you have a different approach)
        existing_instagram_ids.append(filename.split('_')[0])  # Extract Instagram ID from filename
...
if os.path.exists(csv_file_path):
    with open(csv_file_path, 'r') as csvfile:
        ...
        for row in reader:
            ...
            existing_instagram_ids.append(row['instagram_id'])
...
def upload_image():
    if request.method == 'POST':
        ...
        existing_instagram_ids.append(instagram_id)
        ...
        return render_template('index.html', success="Image uploaded and data stored successfully.")
...
def compare_image():
    ...
    if match_index is not None:
        ...
        return render_template('index.html', success=f'Image matched successfully with {matched_desired_name.replace("_"," ")}', match=True,
                               ...
                               matched_instagram_id=matched_instagram_id,
